...
- **Requirements:** R13, R4.
- **Dependencies:** U1–U8.
- **Files:** `docs/design/balance/matrix_baseline_2026-06-*.csv/.md` (post-change N=100 1v1 matrix + 2v2 sweep outputs), `docs/reports/2026-06-healer-movement.md` (new — before/after winrates, draw rates, KPI deltas, replay-review notes), `scripts/movement_kpis.sh` (final KPI extraction).
...
- Baselines: `docs/design/balance/matrix_baseline_2026-05-23_pet_dispatch_1v1_post_n100.md` (1v1, mirror bias), `docs/design/balance/matrix_baseline_2026-05-22_pet_engage_2v2_post.md` (2v2 draw wall).
